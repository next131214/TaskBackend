...
type ComplexityRoot struct {
	Mutation struct {
		...
		UpdateTodo func(childComplexity int, input ModifyTodo) int
	}
...
type MutationResolver interface {
	...
	UpdateTodo(ctx context.Context, input ModifyTodo) (string, error)
	DeleteTodo(ctx context.Context, input DeleteTodo) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateTodo":
		...
		return e.complexity.Mutation.UpdateTodo(childComplexity, args["input"].(ModifyTodo)), true
...
func (ec *executionContext) field_Mutation_deleteTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 DeleteTodo
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNdeleteTodo2githubᚗcomᚋsky0621ᚋstudyᚑgraphqlᚋbackendᚐDeleteTodo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 ModifyTodo
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNmodifyTodo2githubᚗcomᚋsky0621ᚋstudyᚑgraphqlᚋbackendᚐModifyTodo(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_updateTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateTodo(rctx, args["input"].(ModifyTodo))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputmodifyTodo(ctx context.Context, obj interface{}) (ModifyTodo, error) {
	var it ModifyTodo
	var asMap = obj.(map[string]interface{})
...
func (ec *executionContext) unmarshalNdeleteTodo2githubᚗcomᚋsky0621ᚋstudyᚑgraphqlᚋbackendᚐDeleteTodo(ctx context.Context, v interface{}) (DeleteTodo, error) {
	return ec.unmarshalInputdeleteTodo(ctx, v)
}

func (ec *executionContext) unmarshalNmodifyTodo2githubᚗcomᚋsky0621ᚋstudyᚑgraphqlᚋbackendᚐModifyTodo(ctx context.Context, v interface{}) (ModifyTodo, error) {
	return ec.unmarshalInputmodifyTodo(ctx, v)
}
